...
final cameraControllerProvider = StateNotifierProvider<CameraControllerNotifier,
    AsyncValue<CameraController>>((ref) {
...
class CameraControllerNotifier
  ...
  Future<void> _initializeCamera() async {
    try {
      ...
      print(
          '[VisionAid Camera] Initialized successfully (torch supported: $_torchSupported)');
    } catch (e, stack) {
  ...
  bool get isFlashOn =>
      _torchSupported && _controller?.value.flashMode == FlashMode.torch;
